...
public class L6_ZigZag_M {
    ...
    public String convert(String s, int numRows) {
        ...
        // create StringBuilder array to store the testing.string in order
        ...
        // i % 5!!!
        int modu = 2 * numRows ;
        // incrementally loop through the testing.string
        // and logically put into testing.string buffer
        while(i < s.length()) {
